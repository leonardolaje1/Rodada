    ...
    <div className="card">
      ...
      <ResponsiveContainer width="100%" height={220}>
        <ComposedChart data={data} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
          ...
          />
          <Area type="monotone" dataKey="tsb" fill="#4A9EFF22" stroke="none" name="TSB (forma)" />
          <Line type="monotone" dataKey="ctl" stroke="#C4F135" strokeWidth={2} dot={false} name="CTL (fitness)" />
          <Line type="monotone" dataKey="atl" stroke="#F14A4A" strokeWidth={1.5} dot={false} name="ATL (fatiga)" />
        </ComposedChart>
      </ResponsiveContainer>
    </div>
  )
